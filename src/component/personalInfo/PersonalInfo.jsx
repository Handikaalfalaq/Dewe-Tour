...
function PersonalInfo (){
    return (
        <div style={{display:'flex', width:'1440px', backgroundColor:'#F1F1F1', zIndex:'1'}}>
            <div style={{display:'flex', width:'1440px', backgroundColor:'#F1F1F1', zIndex:'1', paddingTop:'114px'}}>
